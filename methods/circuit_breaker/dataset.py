...
class CircuitBreakerDataset(CustomDataset):
    ...
    def __getitem__(self, i) -> Dict[str, torch.Tensor]:
        ...
        cb_tokenized_kwargs = dict(max_length=int(self.max_length/2), padding='max_length', truncation=True, return_tensors="pt")
        tokenize_kwargs = dict(max_length=int(self.max_length), padding="max_length", truncation=True, return_tensors="pt")
