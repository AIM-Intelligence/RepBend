...
from methods.args import (HyperparamArguments, LoraArguments, ModelArguments,
                          TrainingArguments)
from methods.NPO.dataset import NPODataset
from methods.NPO.trainer import CustomTrainer
...
def train():
    ...
    train_dataset = NPODataset(tokenizer, num_examples=10000, max_length=1024, model_name_or_path=model_name_or_path, dataset_path=training_args.dataset_path, split=training_args.dataset_split)
